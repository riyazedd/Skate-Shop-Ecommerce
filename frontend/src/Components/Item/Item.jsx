...
const Item = (props) => {
  return (
    <Link to={`/product/${props.id}`}><div onClick={window.scrollTo(0,0)} className='w-[350px] h-[500px] hover:scale-105 transition-all hover:cursor-pointer border hover:shadow-lg rounded-md'>
